        ...
        <ScrollView contentContainerStyle={styles.legalContent} showsVerticalScrollIndicator={false}>
          {isImprint ? (
            ...
            <>
              ...
              <Text style={styles.legalText}>Das Backend wird über Render bereitgestellt; der Render-Service ist im Projekt für die Region Frankfurt konfiguriert. Die Datenbank wird über Supabase auf AWS in der Region eu-west-1 (Irland) betrieben. Dein Wohnort in Hamburg bestimmt nicht automatisch den Serverstandort.</Text>
